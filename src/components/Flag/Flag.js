...
export default function Flag(props) {
  ...
  switch (props.name) {
    ...
    case 'Spanish':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-es" viewBox="0 0 512 512">
    ...
    case 'Swedish':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-se" viewBox="0 0 512 512">
        <defs>
          <clipPath id="a">
    ...
    case 'Norwegian':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-no" viewBox="0 0 512 512">
    ...
    case 'Greek':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-gr" viewBox="0 0 512 512">
        <defs>
          <clipPath id="a">
    ...
    case 'Dutch':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-nl" viewBox="0 0 512 512">
    ...
    case 'Italian':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-it" viewBox="0 0 512 512">
        <g fill-rule="evenodd" stroke-width="1pt">
          <path fill="#fff" d="M0 0h512v512H0z"/>
    ...
    case 'Polish':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-pl" viewBox="0 0 512 512">
        <g fill-rule="evenodd">
