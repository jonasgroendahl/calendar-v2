...
export default function Flag(props) {
  ...
  switch (props.name) {
    ...
    case 'Japanese':
      svg = <div className="flag-svg" dangerouslySetInnerHTML={{
        __html: `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-jp" viewBox="0 0 512 512"><defs><clipPath id="a"><path fill-opacity=".7" d="M177.2 0h708.6v708.7H177.2z"/></clipPath>
      </defs><g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#a)" transform="translate(-128) scale(.72249)">
